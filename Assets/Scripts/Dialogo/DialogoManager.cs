...
public class DialogoManager : Singleton<DialogoManager>
{
    ...
    private void Update()
    {
        ...
        if (panelDialogo.activeSelf == false && UIManager.Instance.EstaAbiertoPanelInspectorQuest() == false)
        {
        ...
        if (UIManager.Instance.EstaAbiertoPanelInspectorQuest() == false)
        {
            if (Input.GetKeyDown(KeyCode.Space))
            {
                if (despedidaMostrada)
                {
                    AbrirCerraPanelDialogo(false);
    ...
    public void AbrirCerraPanelDialogo(bool estado) 
    {
